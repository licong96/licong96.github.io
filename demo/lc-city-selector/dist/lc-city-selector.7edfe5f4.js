...
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } } // import './lc-city.css';
...
;
},{"./lc-city.scss":13,"./data.json":7,"./util.js":8}],2:[function(require,module,exports) {
'use strict';

var _lcCity = require('./src/lc-city.js');
...
// 有默认选项，进行回填
var defaultCity = new _lcCity2.default({
  data: {
    province: '江西省',
    city: '南昌市',
    district: '青山湖区'
...
},{"./src/lc-city.js":4}],28:[function(require,module,exports) {
